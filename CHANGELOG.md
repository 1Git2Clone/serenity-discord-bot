...
- The 17 embed (GIF) commands are now generated by a declarative `embed_commands!` proc macro in the derive crate instead of one near-identical file each; behavior is unchanged
